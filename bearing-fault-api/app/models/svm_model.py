...
class SVMModel(BaseModel):
    ...
    def load(self) -> bool:
        ...
        try:
            model_path = MODEL_PATHS["svm"]["model"]
            scaler_path = MODEL_PATHS["svm"]["scaler"]
            ...
            logger.info(f"SVM model loaded. Expected features: {self.expected_features}")
            return True
    ...
    def expects_3d(self) -> bool:
        """SVM expects flattened 2D input."""
        return False